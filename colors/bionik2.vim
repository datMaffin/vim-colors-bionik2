...
" Last Updated: Fr 04 Nov 2022 19:27:17 CET
...
if &background ==# 'dark'
  ...
  hi CursorLineNr guifg=NONE guibg=#555753 gui=bold cterm=bold
  ...
  hi ColorColumn guifg=NONE guibg=#555753 gui=NONE cterm=NONE
  hi CursorLine guifg=NONE guibg=#555753 gui=NONE cterm=NONE
  ...
  hi Search guifg=NONE guibg=#2e3436 gui=reverse cterm=reverse
  ...
  hi Todo guifg=#c4a000 guibg=#3465a4 gui=italic,underline cterm=italic,underline
  ...
  hi LineNr guifg=NONE guibg=#eeeeec gui=NONE cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi CursorLineNr ctermfg=NONE ctermbg=DarkGrey cterm=bold
    ...
    hi Todo ctermfg=DarkYellow ctermbg=DarkBlue cterm=italic,underline
    ...
    hi Normal ctermfg=NONE ctermbg=NONE cterm=NONE
    hi Terminal ctermfg=NONE ctermbg=NONE cterm=NONE
    hi LineNr ctermfg=NONE ctermbg=White cterm=NONE
