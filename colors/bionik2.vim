...
" Last Updated: So 06 Nov 2022 12:29:43 CET
...
if &background ==# 'dark'
  ...
  hi Todo guifg=#c4a000 guibg=#3465a4 gui=italic,reverse,underline cterm=italic,reverse,underline
  ...
  hi Search guifg=#0a5594 guibg=#ffffff gui=reverse cterm=reverse
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi Normal ctermfg=NONE ctermbg=NONE cterm=NONE
    hi Terminal ctermfg=NONE ctermbg=NONE cterm=NONE
    hi IncSearch ctermfg=LightYellow ctermbg=fg cterm=reverse
    hi Search ctermfg=LightBlue ctermbg=fg cterm=reverse
    hi Visual ctermfg=DarkGrey ctermbg=White cterm=reverse
