...
" Last Updated: Fr 04 Nov 2022 21:48:06 CET
...
if &background ==# 'dark'
  ...
  hi Todo guifg=#fce94f guibg=#3465a4 gui=italic,underline cterm=italic,underline
  ...
  hi Statement guifg=#3465a4 guibg=NONE gui=bold,italic cterm=bold,italic
  hi Comment guifg=#4e9a06 guibg=NONE gui=NONE cterm=NONE
  hi Todo guifg=#d6c643 guibg=#3465a4 gui=italic,underline cterm=italic,underline
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi Todo ctermfg=LightYellow ctermbg=DarkBlue cterm=italic,underline
